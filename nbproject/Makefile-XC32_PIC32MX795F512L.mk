...
SOURCEFILES_QUOTED_IF_SPACED=configuration_bits.c exceptions.c interrupts.c main.c system.c user.c "Primitives LLD/TimeDelay.c" "Primitives LLD/SSD1963.c"

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/configuration_bits.o ${OBJECTDIR}/exceptions.o ${OBJECTDIR}/interrupts.o ${OBJECTDIR}/main.o ${OBJECTDIR}/system.o ${OBJECTDIR}/user.o "${OBJECTDIR}/Primitives LLD/TimeDelay.o" "${OBJECTDIR}/Primitives LLD/SSD1963.o"
POSSIBLE_DEPFILES=${OBJECTDIR}/configuration_bits.o.d ${OBJECTDIR}/exceptions.o.d ${OBJECTDIR}/interrupts.o.d ${OBJECTDIR}/main.o.d ${OBJECTDIR}/system.o.d ${OBJECTDIR}/user.o.d "${OBJECTDIR}/Primitives LLD/TimeDelay.o.d" "${OBJECTDIR}/Primitives LLD/SSD1963.o.d"

# Object Files
OBJECTFILES=${OBJECTDIR}/configuration_bits.o ${OBJECTDIR}/exceptions.o ${OBJECTDIR}/interrupts.o ${OBJECTDIR}/main.o ${OBJECTDIR}/system.o ${OBJECTDIR}/user.o ${OBJECTDIR}/Primitives\ LLD/TimeDelay.o ${OBJECTDIR}/Primitives\ LLD/SSD1963.o

# Source Files
SOURCEFILES=configuration_bits.c exceptions.c interrupts.c main.c system.c user.c Primitives LLD/TimeDelay.c Primitives LLD/SSD1963.c
...
${OBJECTDIR}/Primitives\ LLD/TimeDelay.o: Primitives\ LLD/TimeDelay.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/Primitives LLD/TimeDelay.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/Primitives LLD/TimeDelay.o.d" -o "${OBJECTDIR}/Primitives LLD/TimeDelay.o" "Primitives LLD/TimeDelay.c"   
...
${OBJECTDIR}/Primitives\ LLD/SSD1963.o: Primitives\ LLD/SSD1963.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/Primitives LLD/SSD1963.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/Primitives LLD/SSD1963.o.d" -o "${OBJECTDIR}/Primitives LLD/SSD1963.o" "Primitives LLD/SSD1963.c"   
...
${OBJECTDIR}/Primitives\ LLD/TimeDelay.o: Primitives\ LLD/TimeDelay.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/Primitives\ LLD/TimeDelay.o.d 
	@${RM} "${OBJECTDIR}/Primitives LLD/TimeDelay.o" 
	@${FIXDEPS} "${OBJECTDIR}/Primitives LLD/TimeDelay.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/Primitives LLD/TimeDelay.o.d" -o "${OBJECTDIR}/Primitives LLD/TimeDelay.o" "Primitives LLD/TimeDelay.c"   
	
${OBJECTDIR}/Primitives\ LLD/SSD1963.o: Primitives\ LLD/SSD1963.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/Primitives\ LLD 
	@${RM} ${OBJECTDIR}/Primitives\ LLD/SSD1963.o.d 
	@${RM} "${OBJECTDIR}/Primitives LLD/SSD1963.o" 
	@${FIXDEPS} "${OBJECTDIR}/Primitives LLD/SSD1963.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/Primitives LLD/SSD1963.o.d" -o "${OBJECTDIR}/Primitives LLD/SSD1963.o" "Primitives LLD/SSD1963.c"   
